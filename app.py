...
def load_data(file_bytes: bytes, file_name: str):
    ...
    buf.name = file_name          # safe_read checks .name
...
#  TABS
# ══════════════════════════════════════════════════════════════
tabs = st.tabs(["📈 Overview","📊 Charts","🔬 Analysis","🔍 Deep Dive","🗃️ Data","💾 Export","🤖 AI Chat"])
tab_overview, tab_charts, tab_analysis, tab_deep, tab_data, tab_export, tab_chat = tabs
